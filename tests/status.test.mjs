...
const outcome = (toolUseId, outcome, extra = {}) => ({ ts: "2026-08-10T00:00:01.000Z", hook: outcome === "failure" ? "PostToolUseFailure" : "PostToolUse", tool: "store_memory", session: "s1", toolUseId, outcome, ...extra });
